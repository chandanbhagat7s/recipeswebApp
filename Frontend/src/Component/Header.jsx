    ...
    <div className=" bg-red-800  ">
      <div className="bg-white  w-[100vw] flex   px-5 lg:px-16 py-1 lg:flex-row items-center fixed flex-col md:flex-row space-y-2 md:space-y-0">
        ...
        <div className="serach w-2/2 md:w-1/3">
          <input
            type="text"
            className="px-5 py-2 text-red-500 rounded-full border border-red-500 outline-none focus:ring-red-700 w-full focus:border-2 "
        ...
        <nav className="flex space-x-2 w-2/2 md:w-1/3 justify-end text-sm md:text-md">
          ...
          <Link
            className="p-2 rounded text-red-300 hover:bg-red-500 hover:text-white font-bold border border-red-300 cursor-pointer"
            to={"/createRecipe"}
          >
            Create Recipe
          </Link>
